...
export default function JobDetails() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_a76cpvc", "template_9crqcdb", form.current, {
        // Use form ref here
        publicKey: "wEkmX3LO3928Ci371",
      })
      .then(
        () => {
          console.log("SUCCESS!");
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="w-full  py-20 flex items-center md:px-8 px-2  justify-center flex-col  ">
            <div className="w-full h-40 bg-gray-50 text-info-600 font-bold flex items-center justify-center flex-col">
              <h1 className="text-3xl">Internship Details</h1>
            </div>
              ...
              <div className="flex w-full px-8 md:px-20 items-start md:flex-row flex-col md:justify-between justify-center">
                ...
                <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                  <div className="flex items-center justify-center mb-1">
                    <FaUserAstronaut className="text-xs font-semibold text-info-600" />
                    <p className="font-semibold text-base mx-1">Job Poster </p>
                    <p className=" text-sm text-gray-800 mx-1">
                      {/* {JobDetails?.user?.name} */} Garv Chawla
                    </p>
                  </div>
                  <div className="flex items-center justify-center mb-1">
                    <MdEmail className="text-xs font-semibold text-info-600" />
                    <p className="font-semibold text-base mx-1">Email </p>
                    <p className=" text-sm text-gray-800 mx-1">
                      {/* {JobDetails?.user?.email} */} garvchawla@gmail.com
                    </p>
                  </div>
                </div>
                <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                  <div className="flex items-center justify-center mb-1">
                    <GoLocation className="text-xs font-semibold text-info-600" />
                    <p className="font-semibold text-base mx-1">Location </p>
                    <p className=" text-sm text-gray-800 mx-1">Mumbai</p>
                  </div>
                  <div className="flex items-center justify-center mb-1">
                    <MdCategory className="text-xs font-semibold text-info-600" />
                    <p className="font-semibold text-base mx-1">Category </p>
                    <p className=" text-sm text-gray-800 mx-1">
                      {/* {JobDetails?.job_category} */} Web Development
                    </p>
                  </div>
                </div>
                <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                  <div className="flex items-center justify-center mb-1">
                    <BsBriefcaseFill className="text-xs font-semibold text-info-600" />
                  ...
                  <div className="flex items-center justify-center mb-1">
                    <AiOutlineDollarCircle className="text-xs font-semibold text-info-600" />
                    <p className="font-semibold text-base mx-1">Salary </p>
                    <p className=" text-sm text-gray-800 mx-1">
                      {/* $ {JobDetails?.salary}{" "} */} $2000
                    </p>
                  </div>
                </div>
                  ...
                  {JobDetails?.user?.email === user?.email ? (
                    ...
                    <div className="flex items-center justify-center  ">
                      <BsFillBookmarkCheckFill
                        ...
                        className="text-info-600 text-4xl cursor-pointer  mx-2"
                      />
                      <button
                        onClick={handleApply}
                        className="md:px-6 md:py-3 px-3 py-2 mt-2 md:mt-0 bg-info-500 rounded text-base tracking-widest uppercase transition-all duration-700 hover:bg-info-900 text-white  "
                      >
                        Apply Position
                      </button>
                    </div>
            ...
            <div className="w-full md:px-4 py-2 flex items-center md:items-start md:flex-row flex-col justify-start md:justify-center">
              <div className="md:w-8/12 w-full md:px-4 py-8 flex flex-col items-center content-start justify-center ">
                <h1 className="text-center lg:text-2xl font-semibold text-xl mb-4 uppercase border-b-2 border-info-600 py-2">
                  Job Description
                </h1>
                <p className="px-4">
                    {/* {JobDetails?.description} */} Knowledge of html ,css and js
                </p>
              </div>
              <div className="md:w-4/12 w-full py-8 px-4 md:px-10">
                <h1 className=" text-2xl font-semibold mb-2">Job Summary</h1>
                <div className="flex items-center justify-start mb-3">
                  <RiUserSearchFill className="text-base font-semibold text-info-600" />
                  <p className="font-semibold text-base mx-1">
                    Total Vacancies{" "}
                  </p>
                  <p className=" text-sm text-gray-800 mx-1">
                    {/* {JobDetails?.job_vacancy} */} 2
                  </p>
                </div>
                <div className="flex items-center justify-start mb-3">
                  <BsFillCalendar2DateFill className="text-base font-semibold text-info-600" />
                ...
                <div className="flex items-center justify-start mb-3">
                  <HiOutlineStar className="text-base font-semibold text-info-600" />
                  <p className="font-semibold text-base mx-1">
                    Experience Required
                  </p>
                  <p className=" text-sm text-gray-800 mx-1">
                    {/* {JobDetails?.job_experience} */} 1
                  </p>
                </div>
              </div>
            </div>
            <div className="w-full px-2 md:px-8 mb-2 flex flex-col">
              ...
              <div className="md:px-8 px-2 md:mx-4 flex flex-wrap items-center justify-center">
                      ...
                      >
                        ...
                        <div className="flex flex-col px-1 md:px-4 py-6 items-start justify-center">
                          <div className="flex px-1 md:px-4 items-center justify-start mb-2">
                            <BsBriefcaseFill className="text-base font-semibold text-info-600" />
                          ...
                          <div className="flex px-1 md:px-4 items-center justify-center mb-2">
                            <AiOutlineDollarCircle className="text-base font-semibold text-info-600" />
                            <p className="font-semibold text-xs md:text-base mx-1">
                              Salary{" "}
                            </p>
                            <p className=" text-sm text-gray-800 mx-1">
                        ...
                        <button
                          ...
                          className="my-2 py-2 px-4  border border-info-600 uppercase  rounded flex items-center justify-center transition-all duration-700 hover:bg-info-600 hover:text-white text-info-600 font-semibold"
                        >
                          View Detail
                ...
                <form ref={form} style={{display: 'none'}} >
                  <label>Name</label>
                  <input type="text" name="user_name" defaultValue={"Khushi"} />
                  <label>Email</label>
                  <input
                    type="email"
                    name="user_email"
                    defaultValue={"khushijeswani155@gmail.com"}
                  />
                  <label>Message</label>
                  ...
                  <input
                    type="submit"
                    value="Send"
                    defaultValue={"hello thanks for applying job"}
                  />
                </form>
                <button
                  onClick={sendEmail}
                  className="my-2 py-2 px-4  border border-info-600   rounded flex items-center justify-center transition-all duration-700 hover:bg-info-600 hover:text-white text-info-600 font-semibold"
                >
                  Apply{" "}
                </button>
                {/* card */}
